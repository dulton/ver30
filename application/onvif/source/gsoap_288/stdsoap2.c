...
#define _SSL_ERROR(e) { e, #e }
    ...
    SOAP_NMAC struct Namespace namespaces[] =
    {
        ...
        {"wsntw", "http://docs.oasis-open.org/wsn/bw-2", NULL, NULL},
...
# endif
    ...
    soap_envelope_end_out(struct soap *soap)
    {
        if (soap_element_end_out(soap, "SOAP-ENV:Envelope")
                /*|| soap_send_raw(soap, "\r\n", 2)*/)	/* 2.8: always emit \r\n */
            /* 去掉\r\n结束字符解决海康onvif兼容摄像机返回xml格式有误的bug */
            return soap->error;
#ifndef WITH_LEANER
    ...
    {
        //add by boris,修复endpoint为空时出现CLOSE_WAIT的bug
        if ((NULL == endpoint) || (0 == strlen(endpoint))
                || (NULL == action) || (0 == strlen(action)))
        {
    ...
    soap_set_fault(struct soap *soap)
    {
        ...
        //const char **SubC  = soap_faultsubcode(soap); //add by guoqiang.lu. 6/12/2013
        //const char **SubC1 = _soap_faultsubcode(soap);//add by guoqiang.lu. 6/12/2013
        ...
        case SOAP_FAULT:
            ...
            //*SubC  = "ter:InvalidArgVal";
            //*SubC1 = "ter:ServiceNotSupported";
            break;
#ifndef WITH_NOIO
        case SOAP_UDP_ERROR:
        ...
        case SOAP_EOF:
            ...
            *s = "End of file or no input";
            break;
#endif
            //case SOAP_GMI_NOT_SUPPORTED:
            //	*s = "The service is not supported";
            //*SubC = "ter:ServiceNotSupported";
            break;
        default:
#ifndef WITH_NOHTTP
#ifndef WITH_LEAN
