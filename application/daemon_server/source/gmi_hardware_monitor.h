#ifndef _GMI_HARDWARE_MONITOR_H_
#define _GMI_HARDWARE_MONITOR_H_
...
#define AMBA_IAV_PATH		"/dev/iav"
#define AMBA_GPIO_PATH	"/dev/ambad"


#define GMI_HARDWARE_CPU_CHECK  "/opt/bin/CpuCheck.sh"
#define GMI_SENSOR_CHECK  		    "/opt/bin/SensorCheck.sh"


//define Sensor I2C Addrs
#define OV2715_I2C_ADDR	(0x6c>>1)
#define OV9715_I2C_ADDR	(0x60>>1)
#define TW9910_I2C_ADDR	(0x8a>>1)
#define PCA9554_I2C_ADDR 	(0x40>>1)
#define PCA9554A_I2C_ADDR 	(0x70>>1)


#define	IOC_GET_CHIP_ID_EX			0x70
...
#define AMBA_DEBUG_IOC_GET_GPIO			_IOR(AMBA_DEBUG_IOC_MAGIC, 203, GpioControl *)
#define AMBA_DEBUG_IOC_SET_GPIO			_IOW(AMBA_DEBUG_IOC_MAGIC, 203, GpioControl *)


#define ENCODE_BOARD_GPIO_NUM 	31
#define ZOOM_LENS_DF003_GPIO 		51
#define ZOOM_LENS_YB22_GPIO		54
#define BOARD_IRCUT_GPIO_NUM 	83


#define ENCODE_BOARD_NORMAL	1
#define ENCODE_BOARD_LARK		0
    ...
    */
    const uint8_t ByteRevTable[256] = {
