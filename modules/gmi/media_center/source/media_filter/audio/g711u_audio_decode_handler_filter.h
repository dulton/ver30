...
#define SAVE_G711U_AUDIO_DECODE_FILE 0

class G711U_AudioDecodeHandlerFilter : public AudioHandlerFilter
{
protected:
    G711U_AudioDecodeHandlerFilter(void);
    virtual ~G711U_AudioDecodeHandlerFilter(void);

public:
    static  G711U_AudioDecodeHandlerFilter*  CreateNew();
