...
G711U_AudioEncodeSourceFilter*  G711U_AudioEncodeSourceFilter::CreateNew()
{
    return BaseMemoryManager::Instance().New<G711U_AudioEncodeSourceFilter>();
}
...
GMI_RESULT	G711U_AudioEncodeSourceFilter::Initialize( int32_t FilterId, const char_t *FilterName, size_t FilterNameLength, void_t *Argument, size_t ArgumentSize )
{
    ...
    sprintf( FileName, "%p_g711u_encode_audio.711", this );
#elif defined( _WIN32 )
    sprintf_s( FileName, MAX_PATH_LENGTH, "%p_g711u_encode_audio.711", this );
#endif
    printf( "File Name : %s\n", FileName );
#if defined( __linux__ )
...
void_t G711U_AudioEncodeSourceFilter::MediaEncCallBack( void_t *UserDataPtr, MediaEncInfo *EncInfo, ExtMediaEncInfo *ExtEncInfo )
{
    G711U_AudioEncodeSourceFilter *AudioSourceFilter = (G711U_AudioEncodeSourceFilter *) UserDataPtr;
