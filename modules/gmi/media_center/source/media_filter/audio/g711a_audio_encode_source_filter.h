...
#define SAVE_G711A_AUDIO_ENCODE_FILE 0

class G711A_AudioEncodeSourceFilter : public AudioSourceFilter
{
protected:
    G711A_AudioEncodeSourceFilter(void);
    virtual ~G711A_AudioEncodeSourceFilter(void);

public:
    static  G711A_AudioEncodeSourceFilter*  CreateNew();
