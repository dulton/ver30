...
public:
	...
	static MyH264VideoStreamFramer* createNew(UsageEnvironment& env, int streamID, uint16_t IPCMediaDataDispatchServerPort, uint16_t IPCMediaDataDispatchClientPort );
...
protected:
	...
	MyH264VideoStreamFramer(UsageEnvironment& env, int streamID, uint16_t IPCMediaDataDispatchServerPort, uint16_t IPCMediaDataDispatchClientPort );
