...
public:
  ...
  createNew(UsageEnvironment& env, char const* fileName, Boolean reuseFirstSource, uint16_t IPCMediaDataDispatchServerPort, uint16_t IPCMediaDataDispatchClientPort,
