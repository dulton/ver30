...
MediaCenterOpenDevice1CommandExecutor::MediaCenterOpenDevice1CommandExecutor( uint32_t CommandId, enum CommandType Type )
...
MediaCenterOpenDevice1CommandExecutor::~MediaCenterOpenDevice1CommandExecutor(void)
{
}

GMI_RESULT MediaCenterOpenDevice1CommandExecutor::Create( ReferrencePtr<BasePacket>& Packet, SafePtr<BaseCommandExecutor>& CommandExecutor )
{
    MediaCenterOpenDevice1CommandExecutor *OpenDevice1CommandExecutor = (MediaCenterOpenDevice1CommandExecutor*) CommandExecutor.GetPtr();
    ...
    BIGENDIAN_TO_USHORT( Offset, OpenDevice1CommandExecutor->m_ChannelId ); // ChannelId
    Offset += sizeof(uint16_t);

    return GMI_SUCCESS;
}

GMI_RESULT MediaCenterOpenDevice1CommandExecutor::Execute()
{
