...
LogClientStorage LogClientHd;

void ERR_PRINT_LOG(LogClientStorage *LogClientHd, enum DebugLogLevel PrtLevel, const char *FileName, const char *FuncName, int32_t LineNum, const char *fmt, ...)
{
...
void ERR_PRINT_LOG_TEST(LogClientStorage *LogClientHd, enum DebugLogLevel PrtLevel, const char *FileName, const char *FuncName, int32_t LineNum, const char *fmt, ...)
{
	va_list ap;
	time_t curr;
	char strTime[256];
