...
typedef int LogClientStorage;
	
extern LogClientStorage LogClientHd;
void ERR_PRINT_LOG(LogClientStorage *LogClientHd, enum DebugLogLevel PrtLevel, char *FileName, const char *FuncName, int LineNum, const char *fmt, ...);
void ERR_PRINT_LOG_TEST(LogClientStorage *LogClientHd, enum DebugLogLevel PrtLevel, char *FileName, const char *FuncName, int LineNum, const char *fmt, ...);
...
#define DEBUG_LOG_STORAGE(Client, LogLevel, Format, ... )  do{ \
