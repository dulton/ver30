...
#if defined( _WIN32 )
  static DWORD WINAPI workingThreadFunc1( LPVOID lpParameter )
  {
    workingThreadFunc( lpParameter );
	return 0;
  }
#endif
...
#elif defined( _WIN32 )
	HANDLE fWorkingThreadID;
    Boolean fThreadWorking;
#endif
};
...
#if defined( _WIN32 )
	streamState->fThreadWorking = True;
#endif
...
#if defined( _WIN32 )
	streamState->fThreadWorking = False;
#endif
	return NULL;
}
...
#elif defined( _WIN32 )
	fWorkingThreadID = ::CreateThread( NULL, 0, workingThreadFunc1, this, 0, NULL );
#endif
	return 0;
}
...
#elif defined( _WIN32 )
	::TerminateThread( fWorkingThreadID, -1 );
	::CloseHandle( fWorkingThreadID );
	fWorkingThreadID = NULL;
#endif
//	printf("cancel done\n");
	return 0;
}
