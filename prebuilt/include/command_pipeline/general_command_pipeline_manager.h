...
class NotifyCommandReplyParser;
class NotifyCommandReplyProcessor;
class NotifyCommandResultDispatcher;

class GeneralCommandPipelineManager : public BaseCommandPipelineManager
{
public:
    GeneralCommandPipelineManager(void);
    virtual ~GeneralCommandPipelineManager(void);
...
private:
    ReferrencePtr<NotifyCommandResultDispatcher> m_NotifyCommandResultDispatcher;
    ReferrencePtr<NotifyCommandReplyProcessor>   m_NotifyCommandReplyProcessor;
    SafePtr<NotifyCommandReplyParser>	         m_NotifyCommandReplyParser;
};
