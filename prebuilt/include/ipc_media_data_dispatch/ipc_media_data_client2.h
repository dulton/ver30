...
#define IPC_MEDIA_DATA_BUFFERING_FRAME_NUMBER 16
...
class IPC_MediaDataClient2
{
public:
    IPC_MediaDataClient2(void);
    ~IPC_MediaDataClient2(void);
    ...
    void_t     DataCallback  ( uint32_t Offset, uint32_t Length );
    GMI_RESULT NewDataProcess();
...
private:
    ...
    GMI_Thread							                                                            m_ClientThread;
    boolean_t                                                                                       m_ThreadWorking;
    boolean_t                                                                                       m_ThreadExitFlag;

    GeneralCommandPipelineManager                                                                   m_CommandPipeline;
    ReferrencePtr<ApplicationPacket>                                                                m_Packet;
